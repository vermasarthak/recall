...
class FactCreate(BaseModel):
    ...
    @classmethod
    def validate_valid_from(cls, v: Optional[datetime]) -> Optional[datetime]:
        if v is not None:
            return ensure_utc(v)
        return None
...
class FactRecord(BaseModel):
    ...
    @classmethod
    def validate_opt_dt(cls, v: Optional[datetime]) -> Optional[datetime]:
        if v is not None:
            return ensure_utc(v)
        return None
...
class RelationCreate(BaseModel):
    ...
    @classmethod
    def validate_vf(cls, v: Optional[datetime]) -> Optional[datetime]:
        if v is not None:
            return ensure_utc(v)
        return None
