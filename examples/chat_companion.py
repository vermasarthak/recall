            ...
            try:
                ...
                if search_results:
                    ...
                    for r in search_results:
                        xml_parts.append(
                            f"  <fact confidence='{r.fact.confidence}'>{r.fact.predicate} {r.fact.object_value}</fact>"
                        )
                ...
                memory_engine.ingest_turn(speaker=USER_NAME, text=user_input, conversation_id=CONVERSATION_ID)
